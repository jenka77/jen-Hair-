...
const I18N = {
  fr: {
    ...
    "auth.confirmEmail": "Compte créé. Un e-mail de confirmation vient d'être envoyé — cliquez sur le lien pour activer votre compte.",
    "auth.confirmEmailHint": "Vérifiez aussi votre dossier spam ou courrier indésirable. L'e-mail peut mettre quelques minutes à arriver.",
    "auth.resendConfirm": "Renvoyer l'e-mail de confirmation",
    "auth.resendConfirmSending": "Envoi en cours…",
    "auth.resendConfirmSuccess": "Un nouvel e-mail de confirmation a été envoyé. Vérifiez votre boîte de réception et vos spams.",
    "auth.resendConfirmError": "Impossible de renvoyer l'e-mail de confirmation.",
    "auth.emailNotConfirmed": "Votre adresse e-mail n'est pas encore confirmée. Cliquez sur le lien reçu par e-mail, ou renvoyez un e-mail ci-dessous.",
    "auth.emailRequired": "Indiquez votre adresse e-mail.",
    "auth.linkExpired": "Ce lien de confirmation a expiré ou a déjà été utilisé. Utilisez le bouton « Renvoyer l'e-mail de confirmation » ci-dessous.",
    "auth.confirmError": "Impossible de confirmer votre adresse e-mail. Réessayez depuis la page Mon compte.",
    "auth.passwordMismatch": "Les mots de passe ne correspondent pas",
    "auth.emailAlreadyRegistered": "Un compte existe déjà avec cette adresse e-mail. Connectez-vous ou réinitialisez votre mot de passe.",
    "auth.forgotPassword": "Mot de passe oublié ?",
    "auth.forgotTitle": "Mot de passe oublié",
    "auth.forgotLead": "Indiquez votre adresse e-mail. Nous vous enverrons un lien pour choisir un nouveau mot de passe.",
    "auth.forgotSubmit": "Envoyer le lien",
    "auth.forgotSending": "Envoi…",
    "auth.forgotSuccess": "Si un compte existe avec cette adresse, un e-mail de réinitialisation vient d'être envoyé. Vérifiez aussi vos spams.",
    "auth.forgotError": "Impossible d'envoyer l'e-mail de réinitialisation.",
    "auth.recoveryTitle": "Nouveau mot de passe",
    "auth.recoveryLead": "Choisissez un nouveau mot de passe pour votre compte.",
    "auth.recoverySubmit": "Enregistrer le mot de passe",
    "auth.recoverySaving": "Enregistrement…",
    "auth.recoverySuccess": "Mot de passe mis à jour. Vous êtes connectée.",
    "auth.recoveryError": "Impossible de mettre à jour le mot de passe. Réessayez via « Mot de passe oublié ».",
    "auth.recoveryLinkInvalid": "Ce lien a expiré ou n'a pas pu être validé. Demandez un nouvel e-mail via « Mot de passe oublié », puis ouvrez le lien reçu.",
    ...
    "maison.accessories": "Accessoires",
    "maison.accessoriesDesc": "Barrettes, perles, foulards et autres articles pour compléter votre look.",
    ...
    "maison.hairdressers": "Coiffeuses",
    "maison.hairdressersDesc": "Trouvez une coiffeuse près de chez vous, par Land en Allemagne.",
    "maison.hairdressersTag": "Annuaire",
    ...
    "avis.photos": "Photos (facultatif)",
    "avis.photosHint": "Jusqu'à 2 photos (JPEG, PNG ou WebP, 5 Mo max chacune).",
    "avis.photosLoginRequired": "Connectez-vous à votre compte pour joindre des photos à votre avis.",
    "avis.photosTooMany": "Vous ne pouvez joindre que 2 photos maximum.",
    "avis.photosTooLarge": "Chaque photo doit faire 5 Mo ou moins.",
    "avis.photosInvalidType": "Format non accepté. Utilisez JPEG, PNG ou WebP.",
    "avis.photosSelected": "{n} photo(s) sur {max} sélectionnée(s).",
    "avis.photosRemove": "Retirer cette photo",
    "avis.photosUnavailable": "L'envoi de photos est temporairement indisponible.",
    "avis.uploadingPhotos": "Envoi des photos…",
    "coiffeuses.title": "Annuaire des coiffeuses",
    "coiffeuses.lead": "Sélectionnez un Land (État fédéral) pour voir les coiffeuses disponibles dans cette région.",
    "coiffeuses.stateLabel": "Land (Allemagne)",
    "coiffeuses.selectState": "— Choisir un Land —",
    "coiffeuses.resultsTitle": "Coiffeuses disponibles",
    "coiffeuses.pickState": "Choisissez un Land dans le menu déroulant.",
    "coiffeuses.loading": "Chargement…",
    "coiffeuses.empty": "Aucune coiffeuse répertoriée pour ce Land pour l'instant.",
    "coiffeuses.loadError": "Impossible de charger l'annuaire.",
    "coiffeuses.phone": "Téléphone",
    "coiffeuses.address": "Adresse",
    "coiffeuses.travel": "Déplacement",
    "coiffeuses.travelYes": "Déplacement possible",
    "coiffeuses.travelNo": "Sur place uniquement",
    "coiffeuses.wigInstall": "Pose & customisation perruque",
    "coiffeuses.wigInstallYes": "Oui — pose et customisation",
    "coiffeuses.wigInstallNo": "Non proposé",
    "coiffeuses.proLinks": "Comptes professionnels",
    "coiffeuses.noProLinks": "Aucun lien renseigné",
    "coiffeuses.proLinkDefault": "Voir le profil",
    "coiffeuses.noPhone": "Non renseigné",
    "coiffeuses.noAddress": "Non renseignée",
    "states.baden-wuerttemberg": "Baden-Württemberg",
    "states.bayern": "Bavière",
    "states.berlin": "Berlin",
    "states.brandenburg": "Brandebourg",
    "states.bremen": "Brême",
    "states.hamburg": "Hambourg",
    "states.hessen": "Hesse",
    "states.mecklenburg-vorpommern": "Mecklembourg-Poméranie-Occidentale",
    "states.niedersachsen": "Basse-Saxe",
    "states.nordrhein-westfalen": "Rhénanie-du-Nord-Westphalie",
    "states.rheinland-pfalz": "Rhénanie-Palatinat",
    "states.saarland": "Sarre",
    "states.sachsen": "Saxe",
    "states.sachsen-anhalt": "Saxe-Anhalt",
    "states.schleswig-holstein": "Schleswig-Holstein",
    "states.thueringen": "Thuringe",
  ...
  de: {
    ...
    "auth.confirmEmail": "Konto erstellt. Eine Bestätigungs-E-Mail wurde gesendet — klicken Sie auf den Link, um Ihr Konto zu aktivieren.",
    "auth.confirmEmailHint": "Prüfen Sie auch Ihren Spam-Ordner. Die E-Mail kann einige Minuten brauchen.",
    "auth.resendConfirm": "Bestätigungs-E-Mail erneut senden",
    "auth.resendConfirmSending": "Wird gesendet…",
    "auth.resendConfirmSuccess": "Eine neue Bestätigungs-E-Mail wurde gesendet. Prüfen Sie Posteingang und Spam.",
    "auth.resendConfirmError": "Bestätigungs-E-Mail konnte nicht gesendet werden.",
    "auth.emailNotConfirmed": "Ihre E-Mail ist noch nicht bestätigt. Klicken Sie auf den Link in der E-Mail oder senden Sie sie unten erneut.",
    "auth.emailRequired": "Bitte geben Sie Ihre E-Mail-Adresse an.",
    "auth.linkExpired": "Dieser Bestätigungslink ist abgelaufen oder wurde bereits verwendet. Nutzen Sie unten « Bestätigungs-E-Mail erneut senden ».",
    ...
    "auth.emailAlreadyRegistered": "Mit dieser E-Mail existiert bereits ein Konto. Melden Sie sich an oder setzen Sie Ihr Passwort zurück.",
    "auth.forgotPassword": "Passwort vergessen?",
    "auth.forgotTitle": "Passwort vergessen",
    "auth.forgotLead": "Geben Sie Ihre E-Mail-Adresse ein. Wir senden Ihnen einen Link zum Zurücksetzen.",
    "auth.forgotSubmit": "Link senden",
    "auth.forgotSending": "Wird gesendet…",
    "auth.forgotSuccess": "Falls ein Konto mit dieser Adresse existiert, wurde eine E-Mail zum Zurücksetzen gesendet. Prüfen Sie auch Ihren Spam-Ordner.",
    "auth.forgotError": "Zurücksetzungs-E-Mail konnte nicht gesendet werden.",
    "auth.recoveryTitle": "Neues Passwort",
    "auth.recoveryLead": "Wählen Sie ein neues Passwort für Ihr Konto.",
    "auth.recoverySubmit": "Passwort speichern",
    "auth.recoverySaving": "Wird gespeichert…",
    "auth.recoverySuccess": "Passwort aktualisiert. Sie sind angemeldet.",
    "auth.recoveryError": "Passwort konnte nicht aktualisiert werden. Versuchen Sie es erneut über « Passwort vergessen ».",
    "auth.recoveryLinkInvalid": "Dieser Link ist abgelaufen oder ungültig. Fordern Sie eine neue E-Mail über « Passwort vergessen » an und öffnen Sie den Link.",
    ...
    "maison.accessories": "Accessoires",
    "maison.accessoriesDesc": "Haarklammern, Perlen, Tücher und weitere Artikel für Ihren Look.",
    ...
    "maison.hairdressers": "Friseurinnen",
    "maison.hairdressersDesc": "Finden Sie eine Friseurin in Ihrer Nähe — nach Bundesland.",
    "maison.hairdressersTag": "Verzeichnis",
    ...
    "avis.photos": "Fotos (optional)",
    "avis.photosHint": "Bis zu 2 Fotos (JPEG, PNG oder WebP, je max. 5 MB).",
    "avis.photosLoginRequired": "Melden Sie sich an, um Fotos zu Ihrer Bewertung hinzuzufügen.",
    "avis.photosTooMany": "Es sind höchstens 2 Fotos erlaubt.",
    "avis.photosTooLarge": "Jedes Foto darf höchstens 5 MB groß sein.",
    "avis.photosInvalidType": "Ungültiges Format. Bitte JPEG, PNG oder WebP verwenden.",
    "avis.photosSelected": "{n} von {max} Foto(s) ausgewählt.",
    "avis.photosRemove": "Dieses Foto entfernen",
    "avis.photosUnavailable": "Foto-Upload ist vorübergehend nicht verfügbar.",
    "avis.uploadingPhotos": "Fotos werden hochgeladen…",
    "coiffeuses.title": "Friseurinnen-Verzeichnis",
    "coiffeuses.lead": "Wählen Sie ein Bundesland, um verfügbare Friseurinnen in dieser Region anzuzeigen.",
    "coiffeuses.stateLabel": "Bundesland",
    "coiffeuses.selectState": "— Bundesland wählen —",
    "coiffeuses.resultsTitle": "Verfügbare Friseurinnen",
    "coiffeuses.pickState": "Bitte wählen Sie ein Bundesland aus der Liste.",
    "coiffeuses.loading": "Wird geladen…",
    "coiffeuses.empty": "Für dieses Bundesland ist noch keine Friseurin eingetragen.",
    "coiffeuses.loadError": "Verzeichnis konnte nicht geladen werden.",
    "coiffeuses.phone": "Telefon",
    "coiffeuses.address": "Adresse",
    "coiffeuses.travel": "Hausbesuch",
    "coiffeuses.travelYes": "Hausbesuch möglich",
    "coiffeuses.travelNo": "Nur vor Ort",
    "coiffeuses.wigInstall": "Perücken-Installation & Anpassung",
    "coiffeuses.wigInstallYes": "Ja — Installation & Anpassung",
    "coiffeuses.wigInstallNo": "Nicht angeboten",
    "coiffeuses.proLinks": "Professionelle Profile",
    "coiffeuses.noProLinks": "Keine Links hinterlegt",
    "coiffeuses.proLinkDefault": "Profil ansehen",
    "coiffeuses.noPhone": "Nicht angegeben",
    "coiffeuses.noAddress": "Nicht angegeben",
    "states.baden-wuerttemberg": "Baden-Württemberg",
    "states.bayern": "Bayern",
    "states.berlin": "Berlin",
    "states.brandenburg": "Brandenburg",
    "states.bremen": "Bremen",
    "states.hamburg": "Hamburg",
    "states.hessen": "Hessen",
    "states.mecklenburg-vorpommern": "Mecklenburg-Vorpommern",
    "states.niedersachsen": "Niedersachsen",
    "states.nordrhein-westfalen": "Nordrhein-Westfalen",
    "states.rheinland-pfalz": "Rheinland-Pfalz",
    "states.saarland": "Saarland",
    "states.sachsen": "Sachsen",
    "states.sachsen-anhalt": "Sachsen-Anhalt",
    "states.schleswig-holstein": "Schleswig-Holstein",
    "states.thueringen": "Thüringen",
  ...
  en: {
    ...
    "auth.confirmEmail": "Account created. A confirmation email was sent — click the link to activate your account.",
    "auth.confirmEmailHint": "Also check your spam folder. The email may take a few minutes to arrive.",
    "auth.resendConfirm": "Resend confirmation email",
    "auth.resendConfirmSending": "Sending…",
    "auth.resendConfirmSuccess": "A new confirmation email was sent. Check your inbox and spam folder.",
    "auth.resendConfirmError": "Unable to resend the confirmation email.",
    "auth.emailNotConfirmed": "Your email is not confirmed yet. Click the link in the email, or resend it below.",
    "auth.emailRequired": "Please enter your email address.",
    "auth.linkExpired": "This confirmation link has expired or was already used. Use « Resend confirmation email » below.",
    "auth.confirmError": "Unable to confirm your email. Please try again from My Account.",
    "auth.passwordMismatch": "Passwords do not match",
    "auth.emailAlreadyRegistered": "An account already exists with this email. Log in or reset your password.",
    "auth.forgotPassword": "Forgot password?",
    "auth.forgotTitle": "Forgot password",
    "auth.forgotLead": "Enter your email address. We will send you a link to choose a new password.",
    "auth.forgotSubmit": "Send link",
    "auth.forgotSending": "Sending…",
    "auth.forgotSuccess": "If an account exists with this address, a reset email was sent. Also check your spam folder.",
    "auth.forgotError": "Unable to send the reset email.",
    "auth.recoveryTitle": "New password",
    "auth.recoveryLead": "Choose a new password for your account.",
    "auth.recoverySubmit": "Save password",
    "auth.recoverySaving": "Saving…",
    "auth.recoverySuccess": "Password updated. You are logged in.",
    "auth.recoveryError": "Unable to update password. Try again via « Forgot password ».",
    "auth.recoveryLinkInvalid": "This link has expired or could not be validated. Request a new email via « Forgot password », then open the link you receive.",
    ...
    "maison.accessories": "Accessories",
    "maison.accessoriesDesc": "Barrettes, beads, scarves and more to complete your look.",
    ...
    "maison.hairdressers": "Hair stylists",
    "maison.hairdressersDesc": "Find a stylist near you — browse by German state.",
    "maison.hairdressersTag": "Directory",
    ...
    "avis.photos": "Photos (optional)",
    "avis.photosHint": "Up to 2 photos (JPEG, PNG or WebP, 5 MB max each).",
    "avis.photosLoginRequired": "Sign in to attach photos to your review.",
    "avis.photosTooMany": "You can attach at most 2 photos.",
    "avis.photosTooLarge": "Each photo must be 5 MB or smaller.",
    "avis.photosInvalidType": "Unsupported format. Use JPEG, PNG or WebP.",
    "avis.photosSelected": "{n} of {max} photo(s) selected.",
    "avis.photosRemove": "Remove this photo",
    "avis.photosUnavailable": "Photo upload is temporarily unavailable.",
    "avis.uploadingPhotos": "Uploading photos…",
    "coiffeuses.title": "Stylist directory",
    "coiffeuses.lead": "Select a German state to see stylists available in that region.",
    "coiffeuses.stateLabel": "State (Germany)",
    "coiffeuses.selectState": "— Select a state —",
    "coiffeuses.resultsTitle": "Available stylists",
    "coiffeuses.pickState": "Choose a state from the dropdown menu.",
    "coiffeuses.loading": "Loading…",
    "coiffeuses.empty": "No stylists listed for this state yet.",
    "coiffeuses.loadError": "Unable to load the directory.",
    "coiffeuses.phone": "Phone",
    "coiffeuses.address": "Address",
    "coiffeuses.travel": "Travel",
    "coiffeuses.travelYes": "Home visits available",
    "coiffeuses.travelNo": "In-salon only",
    "coiffeuses.wigInstall": "Wig installation & customisation",
    "coiffeuses.wigInstallYes": "Yes — installation & customisation",
    "coiffeuses.wigInstallNo": "Not offered",
    "coiffeuses.proLinks": "Professional accounts",
    "coiffeuses.noProLinks": "No links provided",
    "coiffeuses.proLinkDefault": "View profile",
    "coiffeuses.noPhone": "Not provided",
    "coiffeuses.noAddress": "Not provided",
    "states.baden-wuerttemberg": "Baden-Württemberg",
    "states.bayern": "Bavaria",
    "states.berlin": "Berlin",
    "states.brandenburg": "Brandenburg",
    "states.bremen": "Bremen",
    "states.hamburg": "Hamburg",
    "states.hessen": "Hesse",
    "states.mecklenburg-vorpommern": "Mecklenburg-Western Pomerania",
    "states.niedersachsen": "Lower Saxony",
    "states.nordrhein-westfalen": "North Rhine-Westphalia",
    "states.rheinland-pfalz": "Rhineland-Palatinate",
    "states.saarland": "Saarland",
    "states.sachsen": "Saxony",
    "states.sachsen-anhalt": "Saxony-Anhalt",
    "states.schleswig-holstein": "Schleswig-Holstein",
    "states.thueringen": "Thuringia",
...
const TYPE_CATALOGUE_I18N = {
  ...
  accessoires: { title: "maison.accessories", desc: "maison.accessoriesDesc" },
  commentaires: { title: "maison.feedback", desc: "maison.feedbackDesc" },
  coiffeuses: { title: "maison.hairdressers", desc: "maison.hairdressersDesc" },
};
