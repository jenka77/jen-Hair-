...
const I18N = {
  fr: {
    ...
    "coiffeuses.registerPickState": "Choisissez d'abord votre Land (État) dans le menu ci-dessus pour accéder au formulaire d'inscription.",
  ...
  de: {
    ...
    "coiffeuses.registerPickState": "Wählen Sie zuerst Ihr Bundesland im Menü oben, um das Anmeldeformular zu öffnen.",
  ...
  en: {
    ...
    "coiffeuses.registerPickState": "First select your state from the menu above to access the registration form.",
